...
{
    public class PlcMobBusSocketClientTask : AbstractSocketTask<AbstractModBusTcpMessage>
    {
        private SocketClient<AbstractModBusTcpMessage> mSocket;

        private ushort mSendSeqID;

        public PlcMobBusSocketClientTask() : base(null)
        {
            //this.LocalIpAddress = localipaddress;

            mSendSeqID = (ushort)(new Random().Next(10, 200));
            mSocket = new SocketClient<AbstractModBusTcpMessage>(new ModBusTcpProtocol());
        ...
        protected override void onTaskStarted(object param)
        {
            ...
            bool isConnect = TryConnect(ip, ip, 502);
        ...
        public override void OnReceived(IConnection connection, AbstractModBusTcpMessage message)
        {
