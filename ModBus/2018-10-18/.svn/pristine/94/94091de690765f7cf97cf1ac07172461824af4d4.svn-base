...
//       ┗┻┛　┗┻┛
// 
// Copyirght:	Copyright (C) 2014 - Coffee Software All rights reserved
// Solution:	MetroLoading
// Project:		LoadingCircle
// File:		LoadingCircle.cs
// Author:		MuXiang
// CreateDate: 	2014-06-16 13:56
// ModifyDate:	2014-06-17 14:23
// --------------------------------------------------------------------------------------------------------------------
...
namespace LoadingCircle
{
    ...
    public partial class LoadingCircle : UserControl
    {
        ...
        {
            set {
                int gLeft = value/ 2 - lblMessage.Width/2; //this指Form
                int gTop = value / 2 - lblMessage.Height / 2;

                lblMessage.Location = new Point(gLeft, gTop);
        ...
        {
            set {
                lblMessage.Font = new Font(base.Font.FontFamily, value);
            }
        }
        ...
        protected override void OnSizeChanged(EventArgs e)
        {
            ...
            int gLeft = (base.Width - lblMessage.Width) / 2; 
            int gTop = (base.Height - lblMessage.Height) / 2;
