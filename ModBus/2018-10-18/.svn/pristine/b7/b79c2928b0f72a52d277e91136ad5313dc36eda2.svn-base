...
namespace Ksat.AppPlugIn.Communicate.IocpCore
{
    ...
    public class UdpServer
    {
        ...
        public UdpServer(int receiveBufferSize)
        {
            ...
            m_sendPool = new Common.SocketAsyncEventArgsPool(10);
            Init();
        }
        ...
        {
            sendQueues[((IPEndPoint)remoteEndPoint).Port % sendthread].Enqueue(new Common.SendingQueue() { remoteEndPoint = remoteEndPoint, data = data, offset = offset, length = length });
        }
