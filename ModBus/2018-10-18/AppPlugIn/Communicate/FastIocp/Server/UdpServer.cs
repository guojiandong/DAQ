...
namespace Ksat.AppPlugIn.Communicate.FastIocp.Server
{
    ...
    public sealed class UdpServer<TMessage> : IUdpServer<TMessage> where TMessage : class, Base.Messaging.IMessage
    {
        ...
        private readonly Base.Protocol.IUdpProtocol<TMessage> _protocol = null;
        ...
        public UdpServer(int port, Base.Protocol.IUdpProtocol<TMessage> protocol,
        ...
        public UdpServer(int port, int messageBufferSize,
            Base.Protocol.IUdpProtocol<TMessage> protocol,
            IUdpService<TMessage> service)
        {
        ...
        private void ReceiveCompleted(object sender, SocketAsyncEventArgs e)
        {
            if (e.BytesTransferred > 0 && e.SocketError == SocketError.Success)
            {
                ...
                {
                    Logging.Logger.Error(this.GetType().Name, ex.Message, ex);
