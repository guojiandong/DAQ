...
#region Private Members
        ...
        /// key:server name.
        /// </summary>
        static private readonly Dictionary<string, Base.ISession> _dicHosts =
            new Dictionary<string, Base.ISession>();
#endregion
...
#region Static Methods
            ...
            foreach (Config.Server serverConfig in config.Servers)
            {
                ...
                _dicHosts.Add(serverConfig.Name, Activator.CreateInstance(
                    ...
                    objProtocol.GetType().GetInterface(typeof(Protocol.IProtocol<>).Name).GetGenericArguments()),
                        ...
                        serverConfig.MaxConnections) as Base.ISession);
            }
        }
        /// <summary>
        /// get protocol.
        ...
        /// <returns></returns>
        static public bool TryGetHost(string name, out Base.ISession host)
        {
