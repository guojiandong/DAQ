...
namespace Ksat.AppPlugIn.Communicate.FastIocp.Client
{
    ...
    /// thrift client
    /// </summary>
    public class ThriftClient : SocketClient<Base.Messaging.ThriftMessage>
    {
        /// <summary>
        /// new
        /// </summary>
        public ThriftClient()
            : base(new Base.Protocol.ThriftProtocol())
        {
        }
        /// <summary>
        /// new
        ...
        public ThriftClient(int socketBufferSize, int messageBufferSize)
            : base(new Base.Protocol.ThriftProtocol(), socketBufferSize, messageBufferSize, 3000, 3000)
        {
        }
        /// <summary>
        /// new
            ...
            Action<Exception> onException, Action<byte[]> onResult)
        {
            ...
            base.Send(new Request<Base.Messaging.ThriftMessage>(seqID, string.Concat(service, ".", cmdName), payload,
